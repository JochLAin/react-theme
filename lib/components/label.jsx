...
export default class Label extends Component {
    ...
    render() {
        const { custom, color, className, xs, sm, md, lg, xl, size, widths, check, hidden, ...props } = this.props;
        ...
        switch (custom) {
            ...
            case 'radio':
                return <Tag {...props} className={classes}>
                    ...
                    <span className={Classnames('custom-control-indicator', color && `indicator-${color}`)}></span>
